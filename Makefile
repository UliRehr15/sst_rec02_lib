#############################################################################
# Makefile for building: libsst_rec02_lib_d.a
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  sstRec02Lib.pro
# Template: lib
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile sstRec02Lib.pro
#############################################################################
...
DIST          = /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		sstRec02Lib.pro \
		sstRec02Lib.pro
QMAKE_TARGET  = sst_rec02_lib_d
DESTDIR       = ../libs/#avoid trailing-slash linebreak
TARGET        = libsst_rec02_lib_d.a
...
Makefile: sstRec02Lib.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/i386-linux-gnu/qt5/mkspecs/features/lex.prf \
		sstRec02Lib.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile sstRec02Lib.pro
...
dist: 
	@test -d .tmp/sst_rec02_lib_d1.0.0 || mkdir -p .tmp/sst_rec02_lib_d1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sst_rec02_lib_d1.0.0/ && (cd `dirname .tmp/sst_rec02_lib_d1.0.0` && $(TAR) sst_rec02_lib_d1.0.0.tar sst_rec02_lib_d1.0.0 && $(COMPRESS) sst_rec02_lib_d1.0.0.tar) && $(MOVE) `dirname .tmp/sst_rec02_lib_d1.0.0`/sst_rec02_lib_d1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sst_rec02_lib_d1.0.0
